		...
		<div class="modal-content">
			...
			<div class="modal-body">
				<form action="<?php echo base_url('cari/addPesanan'); ?>" method="post">
					...
					<input type="text" class="form-control noRadius" name="hari" id="hari" value="<?php echo $hasilCari[0]['hari']; ?>" required>
					<label for="jam" class="mt-3"> Jam (yang diinginkan)</label>
					<input type="text" class="form-control noRadius" name="jam" id="jam" value="<?php echo $hasilCari[0]['jam']; ?>" required>
