<div class="jumbotron jumbotron-fluid s1-hero">
	<div id="Judul" class="container text-center text-white">
		<h1 class="judulWeb bigText wow fadeInUp">JaGO</h1>
		...
		<a class="wow fadeInUp btn-lg btn-outline-primary text-white mx-3 px-4 py-3 radiusBorder smText btnHover" data-scroll href="#fitur">Selengkapnya</a>
	</div>
</div>